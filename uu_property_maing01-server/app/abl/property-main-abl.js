...
const Errors = require("../api/errors/property-main-error.js");
...
const logger = LoggerFactory.get("PropertyMainAbl");

class PropertyMainAbl {
  constructor() {
...
module.exports = new PropertyMainAbl();
