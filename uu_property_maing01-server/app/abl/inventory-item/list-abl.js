...
const Errors = require("../../api/errors/inventory-item-error.js").List;
const Warnings = require("../../api/warnings/inventory-item-warnings.js").List;
...
class ListAbl {
  ...
  async list(awid, dtoIn, uuAppErrorMap = {}) {
    const validationResult = this.validator.validate("inventoryItemListDtoInType", dtoIn);
